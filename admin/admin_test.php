        ...
        <div class="function clearfix">
            <div class="col-sm-3 col-xs-3 co-md-3 col-lg-3">
                ...
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li role="presentation" class="active"><a href="admin_data.php">资料管理</a></li>
                    <li role="presentation"><a href="admin_discuss.php">问题管理</a></li>
                    <li role="presentation" class="active"><a href="admin_test.php">自测管理</a></li>
                </ul>
            </div>
            <div class="col-sm-9 col-xs-9 co-md-9 col-lg-9">
                <p style="font-size:20px;font-weight: 900;color:#ff0000">此处实现管理员自测管理</p>
            </div>
        </div>
    </div>
